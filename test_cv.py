...
from src.model import GATNet, GATNetHybrid
...
if __name__ == "__main__":
    ...
    '''
    df_train, df_test = train_test_split(train_df, test_size = 0.2, random_state=16, shuffle = True)
    ...
    for idx, (tr_idx, val_idx) in enumerate(k_fold.split(df_train)):
        ...
        model = GATNetHybrid(**kwargs).to(device)
